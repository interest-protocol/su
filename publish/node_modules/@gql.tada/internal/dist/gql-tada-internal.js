...
var o = "function" == typeof require ? require.resolve : t.createRequire("undefined" == typeof document ? require("url").pathToFileURL(__filename).href : n && n.src || new URL("dist/gql-tada-internal.js", document.baseURI).href).resolve;
...
p.exports = function() {
  ...
  f(f.S + f.F * (!!y && 1 != y.length), "String", {
    fromCodePoint: function fromCodePoint(u) {
      ...
      while (D > t) {
        ...
        r.push(n < 65536 ? h(n) : h(55296 + ((n -= 65536) >> 10), n % 1024 + 56320));
      }
      return r.join("");
    }
  });
  ...
  var q = function stringify(u, e, r) {
    ...
    function serializeObject(u) {
      ...
      t += i;
      var r = [];
      for (var a = 0, o = n || Object.keys(u); a < o.length; a += 1) {
        var s = o[a];
    ...
    function serializeArray(u) {
      ...
      for (var n = 0; n < u.length; n++) {
        var a = serializeProperty(String(n), u);
